...
<img width="1440" height="913" alt="image" src="https://github.com/user-attachments/assets/dcfff0eb-9f83-4d91-ab52-25d66fbda3e8" />
...
<img width="1214" height="634" alt="image" src="https://github.com/user-attachments/assets/b0a0e41b-a907-4f44-b271-c6019a714341" />


## 4. 구현 확인

코드가 있는 폴더에서 build_windows.bat 눌러서 dist에 exe 실행파일 만들어서 확인하면 됨.

## 5. 검토 요청 (Pull Request)

다 만들었으면, 검토해달라고 요청(PR)을 보내주면 돼.
